...
const FEATURES = [
  ...
  },
  {
    ...
    body: "What-if shocks propagate across supplier tiers. Sync or async jobs drain on Cloudflare every five minutes.",
  },
  {
    icon: LineChart,
      ...
      <main className="welcome-page">
        <section className="welcome-hero-block">
          <div className="welcome-hero-copy">
            ...
            <p className="welcome-lead">
              Ripple quantifies exposure across your supplier network with live signals, CVaR
        ...
        <section className="welcome-features">
          ...
          <p className="welcome-section-sub">
            Financial-dashboard UX that is dark, data-dense, and designed for decisions under
            uncertainty.
          </p>
        ...
        <section className="welcome-cta-banner">
          <div>
            ...
            <p>Start with the live demo: Postgres in production, mock mode locally.</p>
          </div>
